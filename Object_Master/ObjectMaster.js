...
const poisonTypeOnly = pokémon.filter(p => p.types.length == 1 && p.types[0] == "poison");
// console.log(poisonTypeOnly);
const dualFlyingTypes = pokémon.filter(p => p.types.length > 1 && p.types[1] == "flying").map(p => p.types[0]);
// console.log(dualFlyingTypes);
